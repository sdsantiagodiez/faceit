...
if __name__ == '__main__':
    ...
    faceit.add_video('terry', 'terry_02.mp4', 'https://www.youtube.com/watch?v=BuHLXWYz9ok')
    faceit.add_video('terry', 'terry_03.mp4', 'https://www.youtube.com/watch?v=K0wlPVPdywI')
    faceit.add_video('terry', 'terry_04.mp4', 'https://www.youtube.com/watch?v=L79t3fPHvlI')
    faceit.add_video('terry', 'terry_05.mp4', 'https://www.youtube.com/watch?v=iaVilbKWhJY')
    faceit.add_video('terry', 'terry_06.mp4', 'https://www.youtube.com/watch?v=0Z3F5gV5Mqg')
    faceit.add_video('terry', 'terry_07.mp4', 'https://www.youtube.com/watch?v=1ja-hTqzIg0')
    faceit.add_video('terry', 'terry_08.mp4', 'https://www.youtube.com/watch?v=8xF0r8D-OmA')
